...
-- Thời gian đã tạo: Th1 12, 2022 lúc 01:31 PM
...
(38, 'Điện', 'Hiện tượng vả đề do IC đánh lửa không đúng thời điểm hoặc đặt cam sai sau khi tiến hành bảo dưỡng.', 'Kiểm tra lại hệ thống IC đánh lửa và cam sai.'),
...
INSERT INTO `log` (`id`, `mota`, `thoigian`) VALUES
(27, 'Hãng xe: a. Mẫu xe: a. Đời xe: a.[Lỗi liên quan đến hệ thống ĐIỆN : Xe không nổ khi đề. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ máy phát điện: Nhỏ hơn 10 năm. Đèn pha ô tô: Yếu, chập chờn. Ổ cắm cấp điện không : Bình thường. Tiếng kêu lạ lúc đề của ô tô : Khác(lỗi khác tại câu hỏi này: ádasd). Kết luận nguyên nhân lỗi tại hệ thống ĐIỆN: iện tượng vả đề do IC đánh lửa không đúng thời điểm hoặc đặt cam sai sau khi tiến hành bảo dưỡng.. Kết Luận cách xử lý: Kiểm tra lại hệ thống IC đánh lửa và cam sai.. Độ tương đồng gần nhất với case: 38. Độ tương đồng: 0.618]', '2022-01-12 19:15:46'),
(28, 'Hãng xe: a. Mẫu xe: a. Đời xe: a.[Lỗi liên quan đến hệ thống ĐIỆN : Xe không nổ khi đề. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ máy phát điện: Nhỏ hơn 10 năm. Đèn pha ô tô: Bình thường. Ổ cắm cấp điện không : Chập chờn. Tiếng kêu lạ lúc đề của ô tô : Hiện tượng va đập bánh răng bất thường ở phía động cơ, nghe rất chói tai.. Kết luận nguyên nhân lỗi tại hệ thống ĐIỆN: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null]', '2022-01-12 19:17:48'),
(29, 'Hãng xe: a. Mẫu xe: a. Đời xe: a.[Lỗi liên quan đến hệ thống ĐIỆN : Xe khó nổ khi đề. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ máy phát điện: Nhỏ hơn 10 năm. Đèn pha ô tô: Bình thường. Ổ cắm cấp điện không : Chập chờn. Tiếng kêu lạ lúc đề của ô tô : Hiện tượng va đập bánh răng bất thường ở phía động cơ, nghe rất chói tai.. Kết luận nguyên nhân lỗi tại hệ thống ĐIỆN: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null]', '2022-01-12 19:19:49'),
(30, 'Hãng xe: a. Mẫu xe: a. Đời xe: a.[Lỗi liên quan đến hệ thống ĐIỆN : Xe khó nổ khi đề. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ máy phát điện: Nhỏ hơn 10 năm. Đèn pha ô tô: Bình thường. Ổ cắm cấp điện không : Bình thường. Tiếng kêu lạ lúc đề của ô tô : Tiếng tanh tách liên tục. Kết luận nguyên nhân lỗi tại hệ thống ĐIỆN: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null]', '2022-01-12 19:22:48'),
(31, 'Hãng xe: a. Mẫu xe: a. Đời xe: a.[Lỗi liên quan đến hệ thống PHANH : Phanh bị kêu. Tuổi thọ má phanh: Nhỏ hơn 100000km. Xe bị cản khi thả phanh: không. Mức dầu phanh: bình thường. Kết luận nguyên nhân lỗi tại hệ thống PHANH: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null].[Lỗi liên quan đến hệ thống ĐỘNG CƠ : Động cơ có hiện tượng chết máy. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ bugi: Nhỏ hơn 7 năm. Tiếng động lạ trong khoang máy: Không. Mức xăng của bầu phao: Thấp. Kết luận nguyên nhân lỗi tại hệ thống ĐỘNG CƠ: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null].[Lỗi liên quan đến hệ thống ĐIỆN : Xe khó nổ khi đề. Tuổi thọ acquy: Nhỏ hơn 5 năm. Tuổi thọ máy phát điện: Nhỏ hơn 10 năm. Đèn pha ô tô: Bình thường. Ổ cắm cấp điện không : Bình thường. Tiếng kêu lạ lúc đề của ô tô : Tiếng tanh tách liên tục. Kết luận nguyên nhân lỗi tại hệ thống ĐIỆN: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null].[Lỗi liên quan đến hệ thống KHÍ THẢI : Khí thải có mùi cháy, khét. Kết luận nguyên nhân lỗi tại hệ thống KHÍ THẢI: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null].[Lỗi liên quan đến hệ thống TRUYỀN LỰC : Xe khó vào số lùi. Kết luận nguyên nhân lỗi tại hệ thống TRUYỀN LỰC: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null].[Lỗi liên quan đến hệ thống CHUYỂN ĐỘNG : Xe di chuyển xóc hơn. Ô tô khi đi đường phẳng: bình thường. Khung xe khi qua đường nhấp nhô: không giao động. Tình trạng lốp: Nứt và chửa lốp. Kết luận nguyên nhân lỗi tại hệ thống CHUYỂN ĐỘNG: Chưa tìm ra. Kết Luận cách xử lý: Chưa tìm ra. Độ tương đồng gần nhất với case: Null. Độ tương đồng: Null]. Triệu chứng KHÁC: dfdfdf', '2022-01-12 19:28:25');
