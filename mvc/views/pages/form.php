...
<div class="form-container">
    <form method="POST" id="form" class="form" enctype="multipart/form-data" role="form" action="">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane  show active" id="tabPhanh" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="tab__content">
                            ...
                            <select class="form-select" aria-label="Default select example" id="tuoithophanh" name="tuoithophanh">
                            ...
                            <select class="form-select" aria-label="Default select example" id="khithaphanh" name="khithaphanh">
                            ...
                            <select class="form-select" aria-label="Default select example" id="mucdauphanh" name="mucdauphanh">
                    ...
                    <div class="tab-pane " id="tabDongCo" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="tab__content">
                            <select class="form-select" aria-label="Default select example" id="trieuchungdongco" name="trieuchungdongco">
                                <option>- Triệu chứng của ô tô liên quan đến hệ thống Động Cơ -</option>
                                <?php
                    ...
                    <div class="tab-pane " id="tabkhiThai" role="tabpanel" aria-labelledby="khiThai-tab">
                        <div class="tab__content">
                            ...
                            <select class="form-select" aria-label="Default select example" id="tuoitho acquy" name="tuoitho acquy">
                                <option>- Tuổi thọ acquy -</option>
                                <?php
                                $check = [];
                                foreach ($cauTraLoiKhiThai as $key => $value) {
        ...
        <div class="d-grid gap-2 col-6 mx-auto btn-container">
            <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" id="submitBtn">Kết Luận</button>
        </div>
    </form>
